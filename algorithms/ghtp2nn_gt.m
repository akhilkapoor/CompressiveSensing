%GHTP2NN_GT Graded Hard Thresholding Pursuit Non-Negative (with ground truth)
% GHTP2NN_GT(y,A,gt) runs the Hard Thresholding Pursuit started with x0=0 and with
...
function [ x,S,NormRes,NbIter, Ss, NormRess ] = ghtp2nn_gt( y, A, gt, x0, MaxNbIter, tolRes, verboseMode )
